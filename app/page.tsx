...
export default function Home() {
  return (
          <div
              ...
              <h1 className="z-10 text-4xl text-transparent bg-white cursor-default text-edge-outline animate-title font-display sm:text-6xl md:text-9xl whitespace-nowrap bg-clip-text pb-4">
                  guna thek
              </h1>
              <div
          ...
          <div
              className="pointer-events-none fixed inset-x-0 bottom-0 z-30 mx-auto mb-10 flex origin-bottom h-full max-h-14 animate-fade-in">
              {/* <DockDemo/> */}
          </div>
      </div>
  );
